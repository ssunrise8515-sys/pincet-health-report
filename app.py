...
.nut-grid{display:grid;grid-template-columns:1fr 1fr;gap:5px;flex:1;min-height:0;}
.nc{border-radius:6px;padding:8px 10px;display:flex;flex-direction:column;gap:5px;}
...
.nc-name{font-size:10pt;font-weight:700;color:#1B1B1B;line-height:1.2;}
...
.bar-track{height:6px;background:#E0E0E0;border-radius:2px;overflow:hidden;}
.bar-fill{height:100%;border-radius:2px;}
.bar-fill.bad{background:#D32F2F;}
.bar-fill.ok{background:#2E7D32;}
.bar-fill.warn{background:#E65100;}
.nc-danger{font-size:7.5pt;font-weight:700;color:#B71C1C;}
.nc-ok-msg{font-size:7.5pt;font-weight:700;color:#1B5E20;}
.nc-wn-msg{font-size:7.5pt;font-weight:700;color:#BF360C;}
.nc-note{font-size:7pt;color:#555;line-height:1.45;}
