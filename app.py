...
cat /home/claude/pincet-deploy/app.py
출력
...
한 줄로 출력하지 말고 들여쓰기 있는 JSON으로 출력하세요.
...
출력 형식:
{
  ...
  "dangerMetrics": [
    {"val": "수치값", "unit": "단위", "norm": "정상기준 설명", "name": "항목명"},
    {"val": "수치값", "unit": "단위", "norm": "정상기준 설명", "name": "항목명"},
    {"val": "수치값", "unit": "단위", "norm": "정상기준 설명", "name": "항목명"}
  ],
  "nutrients": [
    {"name": "항목명", "level": "bad", "levelText": "부족 설명", "pct": 30, "risk": "위험 내용", "note": "설명", "span2": false},
    {"name": "항목명", "level": "ok", "levelText": "정상", "pct": 70, "risk": "", "note": "설명", "span2": false},
    {"name": "항목명", "level": "warn", "levelText": "과잉 주의", "pct": 80, "risk": "위험 내용", "note": "설명", "span2": true}
  ],
  "supplements": [
    {"num": "1", "name": "영양제명", "why": "이유", "eff": "기대효과", "tag": "지금 바로", "tagClass": "now", "accentClass": "r1"},
    {"num": "2", "name": "영양제명", "why": "이유", "eff": "기대효과", "tag": "지금 바로", "tagClass": "now", "accentClass": "r2"},
    {"num": "3", "name": "영양제명", "why": "이유", "eff": "기대효과", "tag": "이달 내", "tagClass": "soon", "accentClass": "r3"},
    {"num": "4", "name": "영양제명", "why": "이유", "eff": "기대효과", "tag": "추가 권장", "tagClass": "opt", "accentClass": "r4"}
  ],
  "insurance": [
    {"headClass": "red", "headTitle": "질환명 발생 시", "headSub": "원인", "costVal": "4,000", "dotClass": "red", "items": ["항목1", "항목2", "항목3"], "arrow": "특약 추천"},
    {"headClass": "navy", "headTitle": "질환명 발생 시", "headSub": "원인", "costVal": "1,500", "dotClass": "navy", "items": ["항목1", "항목2", "항목3"], "arrow": "특약 추천"},
    {"headClass": "teal", "headTitle": "질환명 발생 시", "headSub": "원인", "costVal": "800", "dotClass": "teal", "items": ["항목1", "항목2", "항목3"], "arrow": "특약 추천"}
  ]
}'''
